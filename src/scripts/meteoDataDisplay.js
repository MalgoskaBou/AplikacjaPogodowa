...
document.getElementById('tempMin').innerHTML = object.max ;
...
document.getElementById('icon').src = "imgs/icons/" + object.icon + ".png";
...
document.getElementById('icon1').src = object.;
